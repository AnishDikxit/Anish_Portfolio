          ...
          <div key={weekIndex} className="flex flex-col" style={{ gap }}>
            {week.map((day) => (
              <motion.div
                ...
                className="shrink-0 rounded-[3px] bg-black/[0.08]"
...
const GitHubActivity = ({
  ...
  return (
    <div
      ...
      className={cn(
        "relative max-w-full overflow-hidden rounded-[8px] bg-white p-4 text-[#0c0c0c]",
      ...
      {...props}
    >
      <p className="mb-4 px-1.5 text-base font-medium text-[#0c0c0c]">
        {heading}
      </p>
